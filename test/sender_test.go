...
func TestSendEmailWithGmail(t *testing.T) {
	...
	sender := mail.NewGmailSender(config.EmailSenderName, config.EmailSenderAddress, config.EmailSenderPassword, config.SmtpAuthAddress, config.SmtpServerAddress)
